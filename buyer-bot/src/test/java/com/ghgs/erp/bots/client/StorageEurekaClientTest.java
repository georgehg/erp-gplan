...
@SpringBootTest(classes = {StorageEurekaClient.class, ApiClientConfig.class, BuyerBotTestConfig.class})
public class StorageEurekaClientTest {
  ...
  @Autowired
  private StorageEurekaClient storageClient;
